...
// number of colors.
//
// [D65] is set as the reference white of the resulting color. Use
// [Lab.SetWhitepoint] to set a different reference white.
func MixLab(colors ...Color) *Lab {
	if len(colors) == 0 {
		return &Lab{0, 0, 0, D65}
	}
